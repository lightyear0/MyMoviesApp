...
public class ReviewDBAdapter extends ArrayAdapter<Review> {
    private static final String LOG_TAG =ReviewDBAdapter.class.getSimpleName();
     ...
     */
    public ReviewDBAdapter(Activity context, ArrayList<Review> androidFlavors) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Review topReviews = getItem(position);
        ...
        authorName.setText(topReviews.getAuthor());
        TextView content = convertView.findViewById(R.id.tv_content);
        content.setText(topReviews.getContent());
